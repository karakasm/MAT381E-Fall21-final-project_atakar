...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center', fig.width=6, fig.height=5}
data1 %>%
  filter(type == "total") %>%
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.align='left', fig.width=6, fig.height=5}
data2 %>%
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center', fig.width=3, fig.height=3}
data3 %>%
